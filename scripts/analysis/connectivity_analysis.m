...
if resting_state
    ...
    conditions = {'rest'};
    ROI_str = 'ROIs_mod'; % "ROI_mod" for pVis without DO, "ROI" for pVis with DO
else % task data
    ...
    conditions = {'f' , 'pA', 'pT', 'pV', 'sA', 'sT', 'sV', 'tA', 'tT', 'tV'};
    ROI_str = 'ROIs'; 
...
pVis_name = 'pVis_mod'; % pVis_mod for pVis wihtou DO, pVis for pVis with DO
