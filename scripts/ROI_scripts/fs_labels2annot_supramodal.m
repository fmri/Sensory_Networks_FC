...
ROIs = {'sm_sPCS', 'sm_iPCS', 'sm_midFSG', 'sm_aINS', 'sm_preSMA', 'sm_dACC'};
N_ROIs = length(ROIs);
...
for ss = 1:N
    ...
    for hh = 1:length(hemis)
        ...
        hemi = hemis{hh};
        subj_labels = all_label_files(contains(all_label_files, [subjCode '_' hemi '_sm_']) & contains(all_label_files, ROIs) & contains(all_label_files, '3.label'));
        ...
        write_annotation([projectDir '/data/ROIs/' hemi '.' subjCode '_smROIs3.annot'], annot_verts, annot_labels, annot_ctable);
