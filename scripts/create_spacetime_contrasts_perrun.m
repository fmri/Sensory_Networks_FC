...
%%% freesurfer preprocessed spacetime task data surfaces. Task contrasts
%%% should be per-run, not averaged over runs
...
analysis_name_lh = 'spacetime_contrasts_lh_newcondfiles_run6';
analysis_name_rh = 'spacetime_contrasts_rh_newcondfiles_run6';
TR = 2;
design_type = 'blocked';
...
rlf_name = 'spacetime_contrasts_runlistfile6.txt';
